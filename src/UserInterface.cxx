...
inline void UserInterface::cb_io_file_name_i(Fl_Input*, void*) {
  io_list_update_cb();
}
void UserInterface::cb_io_file_name(Fl_Input* o, void* v) {
  ((UserInterface*)(o->parent()->parent()->parent()->user_data()))->cb_io_file_name_i(o,v);
}

inline void UserInterface::cb_4_i(Fl_Button*, void*) {
  io_file_cb();
}
...
inline void UserInterface::cb_io_generic_file_i(Fl_Input*, void*) {
  io_list_update_cb();
}
void UserInterface::cb_io_generic_file(Fl_Input* o, void* v) {
  ((UserInterface*)(o->parent()->parent()->parent()->user_data()))->cb_io_generic_file_i(o,v);
}
...
inline void UserInterface::cb_apt_show_all_i(Fl_Round_Button*, void*) {
  load_airport_browser();
}
void UserInterface::cb_apt_show_all(Fl_Round_Button* o, void* v) {
  ((UserInterface*)(o->parent()->parent()->user_data()))->cb_apt_show_all_i(o,v);
}

inline void UserInterface::cb_apt_show_installed_i(Fl_Round_Button*, void*) {
  load_airport_browser();
}
void UserInterface::cb_apt_show_installed(Fl_Round_Button* o, void* v) {
...
UserInterface::UserInterface() {
 ...
 (yaw) angle (Psi)");
    ...
    { Fl_Group* o = page[8] = new Fl_Group(150, 25, 490, 420, "Input/Output");
      ...
      { Fl_Group* o = file_group = new Fl_Group(150, 320, 225, 25);
        { Fl_Input* o = io_file_name = new Fl_Input(220, 320, 125, 25, "File:");
          o->labelsize(12);
          o->textsize(12);
      ...
      { Fl_Group* o = serial_group = new Fl_Group(150, 320, 225, 55);
        o->hide();
      ...
      { Fl_Group* o = socket_group = new Fl_Group(150, 320, 225, 85);
        o->hide();
        ...
        { Fl_Round_Button* o = socket_udp = new Fl_Round_Button(290, 380, 85, 25, "UDP");
          o->type(102);
          o->down_box(FL_ROUND_DOWN_BOX);
          o->labelsize(12);
      ...
      { Fl_Group* o = generic_group = new Fl_Group(150, 380, 225, 25);
        ...
        { Fl_Button* o = new Fl_Button(350, 380, 25, 25, "...");
          o->labelsize(12);
    ...
    { Fl_Group* o = page[13] = new Fl_Group(150, 25, 490, 420, "Airport Browser");
      ...
      { Fl_Round_Button* o = apt_show_all = new Fl_Round_Button(155, 55, 60, 25, "All");
        ...
        o->down_box(FL_ROUND_DOWN_BOX);
        o->labelsize(12);
        o->callback((Fl_Callback*)cb_apt_show_all);
      }
      { Fl_Round_Button* o = apt_show_installed = new Fl_Round_Button(215, 55, 70, 25, "Installed");
        o->type(102);
        o->down_box(FL_ROUND_DOWN_BOX);
        o->value(1);
        o->labelsize(12);
