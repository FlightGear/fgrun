 ...
 (yaw) angle (Psi)");
    ...
    { Fl_Group* o = page[13] = new Fl_Group(150, 0, 490, 430, "Weather");
      ...
      { Fl_Group* o = new Fl_Group(155, 35, 230, 280);
        ...
        { Fl_Check_Button* o = random_wind = new Fl_Check_Button(235, 280, 105, 25, "Random Winds");
          o->down_box(FL_DOWN_BOX);
          o->labelsize(12);
      ...
      { Fl_Check_Button* o = fetch_real_weather = new Fl_Check_Button(235, 370, 155, 25, "Fetch real weather");
        o->down_box(FL_DOWN_BOX);
        o->labelsize(12);
      }
      o->end();
